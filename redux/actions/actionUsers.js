...
export const handleGetUsers = () => ({
    ...
    payload: axios.get('http://192.168.43.15:5000/api/v1/webtoons/')
});
...
export const handleSearch = (params) => ({
    ...
    payload: axios.get('http://192.168.43.15:5000/api/v1/webtoons/find/' + params)
});

export const handleEpisode = (params) => ({
    type: types.GET_USERS_EPISODE,
    payload: axios.get('http://192.168.43.15:5000/api/v1/webtoons/' + params + '/episodes')
});

export const handleEpisodeDetail = (webtoonId, episodesId) => {
    return {
        type: types.GET_USERS_EPISODE_DETAIL,
        payload: axios.get('http://192.168.43.15:5000/api/v1/webtoons/' + webtoonId + '/episode/' + episodesId + '')
    }
};

export const handleLogin = (params) => ({
    type: types.GET_USERS_LOGIN,
    payload: axios.post('http://192.168.43.15:5000/api/v1/login', params)
});

export const handleRegister = (params) => ({
    type: types.GET_USERS_REGISTER,
    payload: axios.post('http://192.168.43.15:5000/api/v1/register', params)
});

export const handleCreation = () => ({
    type: types.GET_USERS_CREATION,
    payload: axios.get('http://192.168.43.15:5000/api/v1/users/1/webtoons/')
});
...
export const handleCreate = () => {
    return {
        ...
        payload: axios.get('http://192.168.43.15:5000/api/v1/users/1/webtoons/')
        //payload: axios.post('http://192.168.43.15:5000/api/v1/users/1/webtoon', body)
    };
};
...
export const handleMyfavourite = (params) => {
    return {
        ...
        payload: axios.get('http://192.168.43.15:5000/api/v1/users/' + params + '/favourite')
    };
};
...
export const handleSrcMyfavourite = (id, params) => {
    return {
        ...
        payload: axios.get('http://192.168.43.15:5000/api/v1/users/' + id + '/favourite/' + params + '/find')
    };
};
...
export const handleSaveWebtoon = (params) => {
    return {
        ...
        payload: axios.post('http://192.168.43.15:5000/api/v1/users/1/webtoon', params)
    };
}; 